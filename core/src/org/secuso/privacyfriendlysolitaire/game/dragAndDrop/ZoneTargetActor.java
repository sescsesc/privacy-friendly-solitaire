...
public class ZoneTargetActor extends Actor implements Comparable<ZoneTargetActor> {
    ...
    @Override
    public int compareTo(final ZoneTargetActor other) {
        return Comparator.comparing(ZoneTargetActor::getLocation).thenComparing(ZoneTargetActor::getStackIndex).compare(this, other);
    }
